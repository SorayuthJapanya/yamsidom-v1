...
import { useAdminAddUser } from "../../../api/AuthApi";
...
const AdminSignUpForm = () => {
  ...
  const { mutate: signUpMutation, isLoading } = useAdminAddUser();
      ...
      <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 outline-none bg-white"
            required
          >
            ...
            <option value="ADMIN">ผู้ควบคุมระบบ</option>
          </select>
        </div>
        ...
        <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
          ...
          <p className="text-blue-800 text-sm mt-2">
            <span className="font-medium">ตัวอย่าง:</span> Example123
          </p>
        </div>
